...
#define RPMSG_EPT_NUM 4

#define SHARE_MEM_ADDR            0x43f800000ULL
#define SHARE_MEM_SIZE            0x0007e4000ULL
#define SHARE_MEM_SIZE_PER_THREAD 0x0001c0000ULL // 4 threads supported

#define SHARE_MEM_SRC0_OFFSET    0x000000000ULL
#define SHARE_MEM_SRC1_OFFSET    0x000080000ULL
#define SHARE_MEM_RESULT_OFFSET   0x000100000ULL
